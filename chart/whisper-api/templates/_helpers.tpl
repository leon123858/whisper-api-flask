...
{{ include "whisper-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "whisper-api.selectorLabels" -}}
...
*/}}
{{- define "whisper-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "whisper-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
